  ...
  setPage(page+1)
    ...
    return (
       ...
       <div className="container ">
        ...
        <h2 className='text-center' style={{marginTop:'40px'}}>BuzzLine - Top Headlines on {capitalizeFirstLetter(props.category)}.</h2>
        {loading && <Spinner/>} 
       
        <div className="row">
              {!loading &&  articles.map((element)=>{
          return  <div className="column col-md-4 col-sm-6" key={element.url}>
